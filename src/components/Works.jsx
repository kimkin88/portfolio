...
const ProjectCard = ({
  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        options={{ max: 15, scale: 1, speed: 250 }}
  ...
  return (
    <>
      ...
      <div className="w-full flex">
        ...
        >
          Following projects showcases my skills and experiene through real-word
          examples of my work. Each project is briefly described with links for
          fast demo of the work.
        </motion.p>
      </div>
